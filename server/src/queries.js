export const SELECT_HEROES = 'SELECT heroes.id, heroes.heroe_type, heroes.condition, heroes.image_url, cities.name as city_name, countries.name as country_name FROM heroes, cities, countries WHERE heroes.cities_id = cities.id AND countries.id = cities.countries_id';
...
export const SELECT_VEHICLES_BY_HEROE = 'SELECT * FROM vehicles WHERE id = ?';
